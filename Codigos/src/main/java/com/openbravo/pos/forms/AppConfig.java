...
public class AppConfig implements AppProperties {
  ...
  //Metodo para fijar el color de los botones seleccion de ticket MR.POS
public class BotonColor{
 public boolean BacColor(){
     return false;
 }
}
  /**
...
// secondary DB        
    ...
    m_propsconfig.setProperty(".JButton53", "false");
    ...
    m_propsconfig.setProperty("payment.impresora", "Not defined");
